...
def shape_broadcast(shape1: UserShape, shape2: UserShape) -> UserShape:
    ...
    #     long_shape = list(shape1)
    #     short_shape = shape2
    # else:
    #     long_shape = list(shape2)
    #     short_shape = shape1

    # for i in range(1, len(short_shape) + 1):
    #     if short_shape[-i] == 1 or long_shape[-i] == 1:
    #         long_shape[-i] = max(short_shape[-i], long_shape[-i])
    #     elif short_shape[-i] != long_shape[-i]:
    #         raise IndexingError("Cannot broadcast shapes")

    # return tuple(long_shape)
    a, b = shape1, shape2
    m = max(len(a), len(b))
    c_rev = [0] * m
