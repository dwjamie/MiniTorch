    ...
    for out_pos in prange(out_size):
        ...
        for current_in_channel in prange(in_channels):
            for current_kw in range(kw):
                if not reverse and current_width + current_kw < width:
                    input_val = input[
                        current_batch * s1[0]
                        + current_in_channel * s1[1]
                        + (current_width + current_kw) * s1[2]
                    ]
                elif reverse and current_width - current_kw >= 0:
                    input_val = input[
                        current_batch * s1[0]
                        + current_in_channel * s1[1]
                        + (current_width - current_kw) * s1[2]
            ...
            for current_kh in range(kh):
                for current_kw in range(kw):
                    if (
                        ...
                        reverse
                        and current_height - current_kh >= 0
                        and current_width - current_kw >= 0
                    ):
                        input_val = input[
                            current_batch * s10
                            + current_in_channel * s11
