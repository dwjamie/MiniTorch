    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for out_pos in range(len(out)):
            out_index = array([0 for _ in range(len(out_shape))])
            in_index = array([0 for _ in range(len(in_shape))])
...
def tensor_zip(fn: Callable[[float, float], float]) -> Any:
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for out_pos in range(len(out)):
            out_index = array([0 for _ in range(len(out_shape))])
            a_index = array([0 for _ in range(len(a_shape))])
            b_index = array([0 for _ in range(len(b_shape))])
...
def tensor_reduce(fn: Callable[[float, float], float]) -> Any:
    ...
    * `out_shape` will be the same as `a_shape`
    ...
    def _reduce(
        ...
        # TODO: Implement for Task 2.3.
        for a_pos in range(len(a_storage)):
            a_index = array([0 for _ in range(len(a_shape))])
            out_index = array([0 for _ in range(len(out_shape))])
